...
Preview skill folders for this workshop:

```text
<skills-root>/reading-epic-ehi-export
<skills-root>/ehi-deep-dives
```
...
bun <skills-root>/ehi-deep-dives/scripts/screenshot.ts dist shot.png 1100
bun <skills-root>/ehi-deep-dives/scripts/serve.ts deep-dives 8088
```
