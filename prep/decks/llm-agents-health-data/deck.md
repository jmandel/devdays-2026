...
1. **Let's Build: LLM Agents With Health Data**  
   Open as a workshop, not a keynote. The visual should show a laptop workbench with three real build lanes: `health-skillz`, `request-my-ehi`, and `ehi-2026-06.02/skills`.
...
- Local EHI skills: `/home/jmandel/hobby/ehi-2026-06.02/skills/`
